...
# ● iOS EmAdsSDK更新日志
## 2025-10-14      SDK 2.0.14

修复已知bug

## 2025-7-22      SDK 2.0.10

1、升级百度sdk版本为5.40

2、升级广点通sdk版本为4.15.41

3、升级穿山甲sdk版本为7.0.0.3
...
2、修复pod bundle被合并后SDK内部无法访问资源的问题，修复穿山甲信息流高度不对的问题。

## 2024-09-18      SDK 1.1.1
1、更新百度SDK至5.37，更新快手SDK至3.3.67

2、百度Banner类型广告下线，上线百度插屏广告

3、修复部分BUG

## 2024-09-09      SDK 1.1.0
1、更换config V2
