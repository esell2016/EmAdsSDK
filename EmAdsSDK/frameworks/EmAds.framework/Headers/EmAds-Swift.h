...
SWIFT_CLASS("_TtC5EmAds16AwvrAeeOjSpIvOYk")
@interface AwvrAeeOjSpIvOYk : NSObject
...
SWIFT_CLASS("_TtC5EmAds16BNqnWxKcxyctTqfJ")
@interface BNqnWxKcxyctTqfJ : NSObject
...
/// 广告位没有对应的策略
  EmAdErrorCodeSlotChannelIsNull = 9914,
/// 未知（不使用）
...
/// 获取内部易效宝 SDK 版本号
+ (NSString * _Nonnull)getYxbVersion SWIFT_WARN_UNUSED_RESULT;
/// 获取内部易盟 SDK 版本号
+ (NSString * _Nonnull)getYmVersion SWIFT_WARN_UNUSED_RESULT;
...
/// 设置开屏广告容器视图
- (void)setAdContainer:(UIView * _Nonnull)container;
- (void)loadOnly;
/// 仅拉取广告
- (void)loadOnly:(NSNumber * _Nullable)emSlotId;
/// 展示广告，和loadOnly()方法搭配使用
...
SWIFT_CLASS("_TtC5EmAds16KTGRDPctVfHJegQO")
@interface KTGRDPctVfHJegQO : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC5EmAds16LWknjiGOIhVsarhH")
@interface LWknjiGOIhVsarhH : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC5EmAds16LWmjCPCNEMdZRmbW")
@interface LWmjCPCNEMdZRmbW : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC5EmAds16NbndCQbooBzZNNij")
@interface NbndCQbooBzZNNij : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
